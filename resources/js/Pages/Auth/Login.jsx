            ...
            <div className="min-h-screen flex">
                ...
                <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-20 xl:px-24">
                    <div className="mx-auto w-full max-w-sm lg:w-96">
                        ...
                        {/* Clerk Sign In Component with Email/Password + Social Login */}
                        <div className={`clerk-signin-wrapper transition-opacity duration-300 ${isLoading ? 'opacity-0 h-0 overflow-hidden' : 'opacity-100'}`}>
                            <SignIn 
                                routing="hash"
                                signUpUrl="/register"
